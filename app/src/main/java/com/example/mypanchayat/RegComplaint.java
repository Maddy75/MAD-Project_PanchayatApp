...
import com.example.mypanchayat.databinding.ActivityRegComplaintBinding;
...
public class RegComplaint extends AppCompatActivity {

    ActivityRegComplaintBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityRegComplaintBinding.inflate(getLayoutInflater());
        ...
        binding.spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(RegComplaint.this, "Select values from the list to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerDistrict.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(RegComplaint.this, "Select District to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerTaluka.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(RegComplaint.this, "Select a Taluk to Continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerVillage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(RegComplaint.this, "Select a ward to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.avaasrequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ComplaintsModel newComplaint = new ComplaintsModel(
                        auth.getUid(),
                        selectedStateItem,
                ...
                database.getReference().child("Complaints").push().setValue(newComplaint).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(RegComplaint.this, "Complaint Registered!!", Toast.LENGTH_LONG).show();
