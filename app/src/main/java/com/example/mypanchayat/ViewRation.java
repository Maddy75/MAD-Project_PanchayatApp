...
import com.example.mypanchayat.databinding.ActivityViewRationBinding;
...
public class ViewRation extends AppCompatActivity {

    ActivityViewRationBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityViewRationBinding.inflate(getLayoutInflater());
        ...
        binding.spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(ViewRation.this, "Select values from the list to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerDistrict.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(ViewRation.this, "Select District to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerTaluka.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(ViewRation.this, "Select a Taluk to Continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.spinnerVillage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> adapterView) {
                Toast.makeText(ViewRation.this, "Select a ward to continue", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        binding.btnVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ViewRation.this, RationDisplay.class);
                intent.putExtra("state", selectedStateItem);
                intent.putExtra("district", selectedDistrictItem);
                intent.putExtra("taluka", selectedTalukItem);
                intent.putExtra("village", selectedVillageItem);
                intent.putExtra("ward", selectedWardItem);
