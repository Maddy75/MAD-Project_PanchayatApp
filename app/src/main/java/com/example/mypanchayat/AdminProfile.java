...
import com.example.mypanchayat.databinding.ActivityAdminProfileBinding;
...
public class AdminProfile extends AppCompatActivity {
    ...
    public AdminProfile(String name, String occupation, String phoneNumber, String email) {
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.adminProfilePic.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (data.getData() != null) { // Here getData() function contains the path of the image if user selects any
            ...
            binding.adminProfilePic.setImageURI(sFile);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(AdminProfile.this, "Profile Pic Updated", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
...
//                        Toast.makeText(AdminProfile.this, "Details saved successfully!", Toast.LENGTH_SHORT).show();
//
...
//                        Toast.makeText(AdminProfile.this, "Failed to save details: " + e.getMessage(), Toast.LENGTH_SHORT).show();
//                    }
//                });
//    }
